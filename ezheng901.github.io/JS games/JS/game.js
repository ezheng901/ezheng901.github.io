...
function trivia1() {
    ...
    // give the results
    if (chocSelected) {
        triviaAnswer.innerHTML = fname + " I indeed have eaten an ant. It tasted spicy!";
    }
    else if (tunaSelected) {
        triviaAnswer.innerHTML = fname + " Unfortunately, this did happen to me, and I spent over three days in the hospital!";
    }
    else if (honeySelected) {
        triviaAnswer.innerHTML = fname + " Bravo! You are right! I love the Cars series!";
    }
    else {
